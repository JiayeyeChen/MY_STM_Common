...
enum SERIAL_PROTOCOL_DataLogTask
{
  SERIAL_PROTOCOL_DATALOG_TASK_FREE,
  SERIAL_PROTOCOL_DATALOG_TASK_START_ACTIVE,
  SERIAL_PROTOCOL_DATALOG_TASK_START_PASSIVE,
  SERIAL_PROTOCOL_DATALOG_TASK_SEND_DATA_SLOT_LEN,
  SERIAL_PROTOCOL_DATALOG_TASK_START_SEND_DATA_SLOT_LABEL,
  SERIAL_PROTOCOL_DATALOG_TASK_SEND_DATA_SLOT_LABEL,
  SERIAL_PROTOCOL_DATALOG_TASK_DATALOG,
  SERIAL_PROTOCOL_DATALOG_TASK_END_ACTIVE,
  SERIAL_PROTOCOL_DATALOG_TASK_END_PASSIVE
};
...
typedef struct
{
  ...
  enum SERIAL_PROTOCOL_DataLogTask      datalogTask;
